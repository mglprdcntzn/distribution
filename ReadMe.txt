...
Photo-voltaic injection at the nodes is simulated from an arbitrary nominal power, and typical daily profiles of global irradiation for every month. Wind power injection is simulated in a similar way, based on wind speed data. Both profiles are for the Carriel Sur Airport (CCP), Concepción, Chile (latitude -36.78055, longitude -73.05083).
